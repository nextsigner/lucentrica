...
Rectangle {
    ...
    Timer{
        ...
        interval: 250
        onTriggered: {
            var fs=''+parseInt(app.fs*0.6)
            desPeri='<h1 style="line-height:20%">Perigeo</h1><br><span style="line-height:10%; font-size:'+fs+'px;">La distancia entre la Tierra y la Luna es de <b>362.600 Km</b></span>'
            desApo='<h1 style="line-height:20%">Apogeo</h1><br><span style="line-height:10%; font-size:'+fs+'px;">La distancia entre la Tierra y la Luna es de <b>405.400 Km</b></span>'
        }
    }
