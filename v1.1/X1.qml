...
Rectangle {
    ...
    Column{
        ...
        Row{
            ...
            Text {
                id: t1
                text: '<b>Teoría Lucéntrica</b><br><b style="font-size:'+parseInt(app.fs)+'px;">Lenguaje Castelleno - Versión 1.0</b>'
    ...
    Component.onCompleted: {
        var fsp=parseInt(app.fs*0.65)
        var tt1 = '<p style="font-size:'+fsp+'px;"><b>Teoría creada por: </b> Ricardo Martín Pizarro</p><p style="font-size:'+fsp+'px;"><b>Nacido en: </b>Malargüe Mendoza República Argentina</p>
...
<p style="font-size:'+fsp+'px;"><b>Repositorio Git:</b> https://github.com/nextsigner/lucentrica</p>
<p style="font-size:'+fsp+'px;"><b>E-Mail: </b> nextsigner@gmail.com</p>
<p style="font-size:'+fsp+'px;"><b>Whatsapps:</b> +54 11 3802 4370</p>
<p style="font-size:'+fsp+'px;"><b>Donaciones:</b> paypal.me/lucentrica</p>
'
...
<p style="font-size:'+fsp+'px;">En principio esta teoría está basada en las leyes de la termodinámica y en una afirmación propia de esta misma teoría, dicha afirmación concluye lo siguiente.</p>
...
<p style="font-size:'+fsp+'px;">La llamada fuerza de gravedad planetaria es producto de la atracción de la materia en estado no plasmático hacia el centro de cada esfera, esto sucede por la atracción de la materia hacia el núcleo de luz que se encuentra en el interior de cada esfera o cuerpo celeste de similares características.</p>
